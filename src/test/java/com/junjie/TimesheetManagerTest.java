...
import com.junjie.model.TimesheetManagerImpl;
...
public class TimesheetManagerTest extends TestCase {
  private static final TimesheetManager timesheetManager;

  static {
    ApplicationContext appContext = new ClassPathXmlApplicationContext("application-context.xml");
    timesheetManager = (TimesheetManager) appContext.getBean("timesheetManager");
  }

  public TimesheetManagerTest(String testName) {
    super(testName);
  }
